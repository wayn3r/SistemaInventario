<div class="col-xl-2 col-lg-3 col-md-4 col-12 d-block pt-3 navbar navbar-expand-md navbar-light alert-light border-right border-secondary overflow-auto flex-grow-1" id="sidebar"> 
    <div class="navbar-collapse collapse  pt-2 pb-3 overflow-auto " id="navbar">
        <ul class="nav flex-column accordion flex-grow-1 " id="side-bar" >
            <div class="mb-2 pb-2 border-bottom border-muted ">
