<div class="col-12">
    ...
    <div class="col-10 m-auto p-2 d-flex justify-content-between">
        ...
        <a href="historico.php?id=<?=$this->viewBag->fecha['idFecha']?>&accion=Historico&tipo=articulo">Ver articulos para esta fecha</a>
    </div>
    ...
    <tfoot>
        <tr>
            <td scope="col" colspan="8">
                <span class="text-muted">Registro de inventario de las impresoras existentes para la fecha <?=$this->viewBag->fecha['fecha']?></span>
            </td>
        </tr>
    </tfoot>
    </table>        
